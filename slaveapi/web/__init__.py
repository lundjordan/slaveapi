...
app.add_url_rule("/slaves/<slave>/actions/start", view_func=AWSTerminateInstance.as_view("aws_start_instance"), methods=["GET", "POST"])
app.add_url_rule("/slaves/<slave>/actions/stop", view_func=AWSTerminateInstance.as_view("aws_stop_instance"), methods=["GET", "POST"])
app.add_url_rule("/slaves/<slave>/actions/status", view_func=AWSTerminateInstance.as_view("aws_instance_type"), methods=["GET", "POST"])
